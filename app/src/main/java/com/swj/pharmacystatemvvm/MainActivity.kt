...
class MainActivity : AppCompatActivity() {
    ...
    //var sigunguList: ArrayList<String> = ArrayList() // AutoCompleteTextView 에 들어가는 시군구 리스트
...
//                }
                ...
                runOnUiThread {
                    ...
                    progressBar = null
                    /*findViewById<View>(R.id.iv_medicine).visibility = View.GONE
                    findViewById<View>(R.id.appbar).visibility = View.VISIBLE
                    findViewById<View>(R.id.layout_pharmacy).visibility = View.VISIBLE*/
