...
import com.swj.pharmacystatemvvm.databinding.FragmentHolidayBinding
...
class HolidayFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_holiday, container, false)
...
//        }
    ...
    fun searchName(query: String, mainItems: ArrayList<PharmacyItem>) {
//        items = mainItems
        //currentPage = 1
...
//        }
    ...
    fun searchSigungu(sigungu: String, mainItems: ArrayList<PharmacyItem>) {
//        items = mainItems
        //currentPage = 1
        //tvCurrentPage?.text = currentPage.toString()
//        val tempList = ArrayList<PharmacyItem>()
...
//        }
    ...
    fun setItems(mainItems: ArrayList<PharmacyItem>) {
        //items = mainItems
        //currentPage = 1
        //tvCurrentPage?.text = currentPage.toString()
        //currentItems.clear()
